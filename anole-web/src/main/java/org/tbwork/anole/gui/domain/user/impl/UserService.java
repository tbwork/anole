...
import org.anole.infrastructure.dao.extend.AnoleUserExtMapper;
...
public class UserService implements IUserService {
	...
	@Autowired
	private AnoleUserExtMapper anoleUserExtMapper;
	...
	private void initialize(){
		AnoleUser anoleUser = anoleUserExtMapper.getByUsername("admin");
	...
	public CreateUserResult createUser(CreateUserDemand createUserDemand) { 
		...
		try{
			...
			AnoleUser anoleUser = anoleUserExtMapper.getByUsername(username);
			if(anoleUser == null){
	...
	public List<String> getUsers() {
		...
		List<AnoleUser> userList = anoleUserMapper.selectByExample(new AnoleUserExample());
		if(userList!=null){
