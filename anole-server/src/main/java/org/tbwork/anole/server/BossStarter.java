package org.tbwork.anole.server;
...
import org.tbwork.anole.server.server._4_publisher.BossServer4PublisherStarter;
import org.tbwork.anole.server.server._4_subscriber.BossServer4SubscriberStarter;
import org.tbwork.anole.server.protocal._4_peer.BossServer4WorkerStarter;
import org.tbwork.anole.server.services.IBossRegisterService;
...
/**
 * Yes, Anole boss goes here.
 */
@AnoleConfigLocation(locations = "")
@AnoleClassPathFilter(contains = "anole-*")
@Component
public class BossStarter implements IAppStarter
{  
	private final static Logger logger = LoggerFactory.getLogger(BossStarter.class);
    ...
    {
		ConfigUtil.initialize("boss", configFiles);
