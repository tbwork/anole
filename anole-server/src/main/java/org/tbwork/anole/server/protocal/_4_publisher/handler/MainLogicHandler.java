package org.tbwork.anole.server.server._4_publisher.handler;
...
import org.tbwork.anole.server.lccm.impl.PublisherClientManagerForBoss;
...
public class MainLogicHandler  extends SimpleChannelInboundHandler<C2SMessage> {
	...
	@Autowired
	private IConfigUpdateService configUpdateService;
	...
	private ModifyResultMessage processModifyConfigMessage(ModifyConfigMessage msg, Set<String> affectedEnvs){
 		...
 		return new ModifyResultMessage(configUpdateService.motifyConfig(operator, changeRule, affectedEnvs));
	}
